const demos = [
  () => import('./demos/tokens.demo.js'),
  () => import('./demos/kernel.demo.js'),
  () => import('./demos/button.demo.js'),
  () => import('./demos/check-button.demo.js'),
  () => import('./demos/toggle.demo.js'),
  () => import('./demos/search.demo.js'),
  () => import('./demos/groupbox.demo.js'),
  () => import('./demos/panel.demo.js'),
  () => import('./demos/tabbox.demo.js'),
  () => import('./demos/navigation-bar.demo.js'),
  () => import('./demos/message.demo.js'),
  () => import('./demos/modal.demo.js'),
  () => import('./demos/dialog.demo.js'),
  () => import('./demos/dropdown.demo.js'),
  () => import('./demos/menu-button.demo.js'),
  () => import('./demos/select.demo.js'),
  () => import('./demos/checklist.demo.js'),
  () => import('./demos/permission.demo.js'),
  () => import('./demos/date-picker.demo.js'),
  () => import('./demos/datebox.demo.js'),
  () => import('./demos/timebox.demo.js'),
  () => import('./demos/table.demo.js'),
  () => import('./demos/data-filter.demo.js'),
  () => import('./demos/form.demo.js'),
  () => import('./demos/form-widgets.demo.js'),
  () => import('./demos/elements.demo.js'),
  () => import('./demos/value-list.demo.js'),
  () => import('./demos/multi-value-editor.demo.js'),
  () => import('./demos/field-upload.demo.js')
];
